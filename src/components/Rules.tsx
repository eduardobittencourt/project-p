  ...
  return (
    <section className="flex flex-col gap-8">
      ...
      <p className="font-serif text-xl text-gray">
        ...
        dá direito ao participante de escolher uma data de nascimento para o
        Theo.
      </p>
      <p className="font-serif text-xl text-gray">
        <span className="text-brown">Prazo de 24 horas:</span> Se o participante
        escolher uma data, mas não concluir a confirmação de compra do pacote de
        fraldas dentro de 24 horas, a data escolhida será liberada novamente
      ...
      <p className="font-serif text-xl text-gray">
        ...
        participante que acertar a data de nascimento do bebê ganhará um voucher
